...
const AdminSidebar = memo(({ activeTab, onTabChange, isOpen, onClose }) => {
        ...
        <div className="flex h-[72px] shrink-0 items-center justify-between border-b border-white/[0.06] px-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold tracking-tight">
              ...
              <span className="ml-1.5 rounded-md bg-violet-500/20 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-violet-300 ring-1 ring-violet-500/30">
                Admin
              </span>
            </span>
          </div>
